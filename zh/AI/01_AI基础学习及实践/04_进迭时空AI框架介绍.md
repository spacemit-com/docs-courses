...
- Matrix算力，以**专用加速指令**的方式提供，采用RISC-V custom-1的编码空间，操作数和结果保存复用RVV的VPR寄存器。详细扩展指令描述可以参考我们开源在github的[指令集手册](https://github.com/spacemit-com/riscv-ime-extension-spec)
